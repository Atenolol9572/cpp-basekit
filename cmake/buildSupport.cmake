...
function(generate_version_rc OUT_VAR)
    ...
    if (IS_MULTI_CONFIG)
        ...
        foreach (cfg IN LISTS CMAKE_CONFIGURATION_TYPES)
            set(_cfg_rc "${CMAKE_CURRENT_BINARY_DIR}/version_${cfg}.rc")
            list(APPEND _RC_FILES "$<$<CONFIG:${cfg}>:${_cfg_rc}>")
            set_source_files_properties("${_cfg_rc}" PROPERTIES GENERATED TRUE)
        endforeach ()
    else ()
